...
const LEVELS = [
    ...
    },
    {
        ...
        level_down: [0, 0],
        objects: [
            newSpikes([5630, 2300, 6080, 2310], 30, 0, 10),
            newSpikes([4920, 2300, 5380, 2290], 30, 0, 10),
            newSpikes([4720, 1120, 4630, 970, 4510, 830], 30, 0.003, 10),
            newSpikes([1660, 850, 3200, 850], 100, 0, 10),
            newSpikes([3180, 300, 1750, 270], 60, 0, 10),
    ...
    },
    {
        ...
        walls: [
            ...
            [ 30,	5530, 1090, 5670, 1100, 5560, 1150, 5440, 1170, 5480, 1100, 5530, 1090 ],
            [ 30,	6090, 1170, 6160, 1170, 6160, 1220, 6100, 1270, 6070, 1230, 6090, 1170 ],
        ...
        colliders: [
            ...
            [ 5530, 1090, 5670, 1100, 5560, 1150, 5440, 1170, 5480, 1100, 5530, 1090 ],
            [ 6090, 1170, 6160, 1170, 6160, 1220, 6100, 1270, 6070, 1230, 6090, 1170 ],
